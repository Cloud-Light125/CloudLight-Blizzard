...
describe("GET /v1/update/latest", () => {
  function latestRelease() {
    return {
      ...
      draft: false,
      prerelease: false,
      upload_url: "https://uploads.github.com/repos/yundan125/CloudLight-Blizzard/releases/99/assets{?name,label}",
      html_url: "https://github.com/yundan125/CloudLight-Blizzard/releases/tag/v2.0.7",
      assets: [{
        id: 100,
        name: "CloudLight-Blizzard-2.0.7-win-x64-Setup.exe",
        size: 123456,
        browser_download_url: "https://github.com/yundan125/CloudLight-Blizzard/releases/download/v2.0.7/CloudLight-Blizzard-2.0.7-win-x64-Setup.exe",
      }],
    };
  }
  ...
  it("returns only the latest release fields needed by the client", async () => {
    ...
    expect(await response.json()).toEqual({
      ...
      htmlUrl: "https://github.com/yundan125/CloudLight-Blizzard/releases/tag/v2.0.7",
      assets: [{
        name: "CloudLight-Blizzard-2.0.7-win-x64-Setup.exe",
        downloadUrl: "https://github.com/yundan125/CloudLight-Blizzard/releases/download/v2.0.7/CloudLight-Blizzard-2.0.7-win-x64-Setup.exe",
        size: 123456,
      }],
    });
