...
def set_root_icon(root: Any, image_path: Path | str) -> None:
    # The headless Worker never calls this helper. Keep upstream GUI compatibility
    # without importing Tk/Pillow into the Worker runtime or installer.
