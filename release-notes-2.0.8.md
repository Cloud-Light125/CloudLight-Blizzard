...
- 修复 GitHub 仓库迁移到 `Cloud-Light125` 后 release 与 installer 链接失效的问题。
- 更新 Worker 的 GitHub Release 元数据请求认证，避免匿名 API 限流导致更新服务不可用或返回 HTTP 502。
...
**完整变更**：https://github.com/Cloud-Light125/CloudLight-Blizzard/compare/v2.0.7...v2.0.8
